...
class ToEndpoint(Thread):
    ...
    def set_upload(self, up):
        print('Setting Upload to:', up)
        self.to_send = file
        self.upload = up

    def set_delete(self, dele):
        self.delete = dele

    def set_drive(self, driv):
        print('Setting Drive to:', driv)
        gauth = GoogleAuth()
        gauth.LoadCredentialsFile("src/mycreds.txt")
        if gauth.credentials is None:
            ...
            gauth.Authorize()
        gauth.SaveCredentialsFile("src/mycreds.txt")
